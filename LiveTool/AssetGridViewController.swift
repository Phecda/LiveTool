...
//  LiveTool
//
//  Created by 宿志鹏 on 2018/10/18.
//  Copyright © 2018年 szp. All rights reserved.
//
...
class AssetGridViewController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "PhotoGridCell", for: indexPath) as? PhotoGrid else {fatalError("Unknown cell")}
