...
//  LiveTool
//
//  Created by Jerry Su on 2019/1/3.
...
class AssetTypeViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case .showCollection:
            ...
            guard let assetCollection = collection as? PHAssetCollection else { fatalError("An asset collection expected")}
...
extension AssetTypeViewController: PHPhotoLibraryChangeObserver {
